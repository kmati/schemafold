...
module.exports = function (app) {
	...
	app.get('/v${versionNumber}/${schemaName}/dal', (req, res, next) => {
		let dalInfo = dal.info();
		res.status(200).json(dalInfo);
	});

	// Gets all the ${schemaName} records
	app.get('/v${versionNumber}/${schemaName}', (req, res, next) => {
		dal.findAll()
			.then(arr => {
	...
	app.get('/v${versionNumber}/${schemaName}/:id', (req, res, next) => {
	...
	app.post('/v${versionNumber}/${schemaName}', (req, res, next) => {
		dal.insert(req.body)
			.then(ret => {
				res.status(200).json(ret);
				next();
	...
	app.put('/v${versionNumber}/${schemaName}/:id', (req, res, next) => {
	...
	app.delete('/v${versionNumber}/${schemaName}', (req, res, next) => {
		dal.removeAll()
			.then(ret => {
	...
	app.delete('/v${versionNumber}/${schemaName}/:id', (req, res, next) => {
